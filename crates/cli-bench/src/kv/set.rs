...
use crate::{
    kv::utils::{
        do_placement_set, gen_data, print_latency_table, print_throughput_table,
...
#[axum::async_trait]
impl BenchMark for KvSetBenchArgs {
    ...
    async fn do_bench(&self) -> Result<(), BenchMarkError> {
        ...
        println!(
            "Starting KV Set Benchmark with {} clients, {} worker threads, {} keys, key size: {}, value size: {}, placement center addresses: {:?}",
