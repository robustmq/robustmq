...
pub async fn set_cluster_system_alarm_config() {
    ...
    let mqtt_broker_conf = broker_config();
        ...
        let expect_reply = SetSystemAlarmConfigReply {
            ...
            os_cpu_high_watermark: Some(
                valid_request
                    ...
                    .unwrap_or(mqtt_broker_conf.mqtt_system_monitor.os_cpu_high_watermark),
            ),
            os_cpu_low_watermark: Some(
                valid_request
                    .os_cpu_low_watermark
                    .unwrap_or(mqtt_broker_conf.mqtt_system_monitor.os_cpu_low_watermark),
            ),
            os_memory_high_watermark: Some(
                valid_request.os_memory_high_watermark.unwrap_or(
                    mqtt_broker_conf
                        .mqtt_system_monitor
            ...
            os_cpu_check_interval_ms: Some(
                valid_request.os_cpu_check_interval_ms.unwrap_or(
                    mqtt_broker_conf
                        .mqtt_system_monitor
