...
pub fn engine_save_by_meta_metadata<T>(
...
pub fn engine_get_by_meta_metadata<T>(
    rocksdb_engine_handler: &Arc<RocksDBEngine>,
    key_name: &str,
...
pub fn engine_exists_by_meta_metadata(
    rocksdb_engine_handler: &Arc<RocksDBEngine>,
    key_name: &str,
...
pub fn engine_delete_by_meta_metadata(
    rocksdb_engine_handler: &Arc<RocksDBEngine>,
    key_name: &str,
) -> Result<(), CommonError> {
    engine_delete(
...
pub fn engine_prefix_list_by_meta_metadata<T>(
    rocksdb_engine_handler: &Arc<RocksDBEngine>,
    prefix_key_name: &str,
