...
/// Header version of a concrete response body, at a given api_version.
///
/// `T::header_version` is the per-message rule generated by kafka-protocol, so
/// each response reports its own flexible-version threshold rather than relying
/// on a hand-maintained table.
fn body_header_version<T: HeaderVersion>(_: &T, api_version: i16) -> i16 {
    T::header_version(api_version)
}

/// Correct response-header version for `packet` at `api_version`.
///
/// Non-flexible responses (Produce <v9, Fetch <v12, …) use header v0; flexible
/// ones use v1. Getting this wrong appends a stray tagged-fields byte that
/// clients misparse. Unknown variants fall back to v1 (the flexible default),
/// matching the prior behaviour for every API that reaches this arm.
fn response_header_version(packet: &KafkaPacket, api_version: i16) -> i16 {
    match packet {
        KafkaPacket::ProduceResponse(r) => body_header_version(r, api_version),
        KafkaPacket::FetchResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ListOffsetsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::MetadataResponse(r) => body_header_version(r, api_version),
        KafkaPacket::OffsetCommitResponse(r) => body_header_version(r, api_version),
        KafkaPacket::OffsetFetchResponse(r) => body_header_version(r, api_version),
        KafkaPacket::FindCoordinatorResponse(r) => body_header_version(r, api_version),
        KafkaPacket::JoinGroupResponse(r) => body_header_version(r, api_version),
        KafkaPacket::HeartbeatResponse(r) => body_header_version(r, api_version),
        KafkaPacket::LeaveGroupResponse(r) => body_header_version(r, api_version),
        KafkaPacket::SyncGroupResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeGroupsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ListGroupsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DeleteGroupsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::OffsetDeleteResponse(r) => body_header_version(r, api_version),
        KafkaPacket::SaslHandshakeResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ApiVersionResponse(r) => body_header_version(r, api_version),
        KafkaPacket::SaslAuthenticateResponse(r) => body_header_version(r, api_version),
        KafkaPacket::CreateTopicsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DeleteTopicsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DeleteRecordsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::CreatePartitionsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeConfigsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AlterConfigsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::IncrementalAlterConfigsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::InitProducerIdResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AddPartitionsToTxnResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AddOffsetsToTxnResponse(r) => body_header_version(r, api_version),
        KafkaPacket::EndTxnResponse(r) => body_header_version(r, api_version),
        KafkaPacket::TxnOffsetCommitResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeTransactionsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ListTransactionsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeAclsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::CreateAclsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DeleteAclsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeClientQuotasResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AlterClientQuotasResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeUserScramCredentialsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AlterUserScramCredentialsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::CreateDelegationTokenResponse(r) => body_header_version(r, api_version),
        KafkaPacket::RenewDelegationTokenResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ExpireDelegationTokenResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeDelegationTokenResponse(r) => body_header_version(r, api_version),
        KafkaPacket::GetTelemetrySubscriptionsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::PushTelemetryResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ListConfigResourcesResponse(r) => body_header_version(r, api_version),
        KafkaPacket::OffsetForLeaderEpochResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AlterReplicaLogDirsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeLogDirsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ElectLeadersResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AlterPartitionReassignmentsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ListPartitionReassignmentsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::UpdateFeaturesResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeClusterResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeProducersResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeTopicPartitionsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ConsumerGroupHeartbeatResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ConsumerGroupDescribeResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ShareGroupHeartbeatResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ShareGroupDescribeResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ShareFetchResponse(r) => body_header_version(r, api_version),
        KafkaPacket::ShareAcknowledgeResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DescribeShareGroupOffsetsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::AlterShareGroupOffsetsResponse(r) => body_header_version(r, api_version),
        KafkaPacket::DeleteShareGroupOffsetsResponse(r) => body_header_version(r, api_version),
        _ => 1,
    }
}
    ...
    pub fn encode_data(
        ...
        match wrapper.header {
            ...
            KafkaHeader::Response(header) => {
                // The response *header* is flexible (v1, tagged fields) only from the
                // api_version at which each API became flexible — and that threshold
                // differs per API (e.g. Produce flexes at v9, Metadata at v9, ApiVersions
                // never). A blanket "v1 for everything but ApiVersions" appends a spurious
                // tagged-fields byte to non-flexible responses (Produce v7, Fetch <v12, …),
                // which the client then misparses. Derive it from each response type.
                let resp_header_version =
                    response_header_version(&wrapper.packet, wrapper.api_version);
