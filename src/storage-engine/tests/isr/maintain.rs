...
mod tests {
    ...
    fn isr_maintain_shrink_and_expand() {
        ...
        state.update_follower_progress(2, 1, 1, 0, leader_leo, stale_ts);
        ...
        state.update_follower_progress(2, 1, 1, leader_leo, leader_leo, now_sec);
