...
fn record_basic_metrics_thread(
    ...
    tokio::spawn(async move {
        let record_func = async || -> ResultCommonError {
            ...
            // topic num
            metrics_cache_manager.record_topic_num(
                now,
                cache_manager.broker_cache.topic_manager.topic_list.len() as u64,
            )?;
            ...
            record_mqtt_topics_set(cache_manager.broker_cache.topic_manager.topic_list.len() as i64);
