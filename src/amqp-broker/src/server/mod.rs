...
impl AmqpServer {
    pub fn new(params: AmqpServerParams) -> Self {
        ...
        let tcp_server = TcpServer::new(RobustMQProtocol::AMQP, server_context);

        AmqpServer { tcp_server }
    }
