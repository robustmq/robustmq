...
I know the other party's address; I compose a message and drop it in. Whether they are home or not doesn't matter — the message waits in their mailbox. Messages are split into high, normal, and low priority. When they get home, they open the mailbox and read high-priority messages first.
