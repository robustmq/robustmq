...
Copy and modify config/server.toml into three files: node1.toml, node2.toml, and node3.toml. For configuration file details, please refer to [《RobustMQ Configuration Guide》](../Configuration/BROKER.md)
