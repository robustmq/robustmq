...
**Edge offline message queuing.** Send to an edge Agent's mailbox (high/normal priority); if the edge is offline, messages are persisted and wait; upon reconnection, they are received by priority — high before normal.
