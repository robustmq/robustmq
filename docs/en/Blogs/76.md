...
```
MAILBOX.CREATE                  — Request a mailbox, receive a mail_address
MAILBOX.QUERY.{mail_address}        — Query unread messages (fallback pull)
INBOX.{mail_address}.{priority}     — Point-to-point mailbox communication
