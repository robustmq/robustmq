...
nats request '$mq9.AI.MAILBOX.MSG.mail@uuid1.uuid2' '{"task_id":"t-001","result":"分析完成"}'
# → {"msg_id":0}
...
nats request '$mq9.AI.MAILBOX.MSG.edge@uuid1.uuid2.critical' '{"command":"emergency_stop","reason":"温度过高"}'
